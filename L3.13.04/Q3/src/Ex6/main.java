...
public class main {
    public static void main(String[] args){
        ...
        baralho.visualizarCartas(baralho.getBaralhoDeCartas(), baralho.getQtdDeCartas());
        ...
        while (nO < 0) {
            baralho.embaralhar(baralho.getBaralhoDeCartas(), baralho.getQtdDeCartas());
        ...
        while (n1 < 0) {
            baralho.ordenar(baralho.getBaralhoDeCartas(), baralho.getQtdDeCartas());
