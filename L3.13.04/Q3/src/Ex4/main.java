...
public class main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < nP; i++) {
            ...
            System.out.println("Digite o nome da cor!");
            String cor = keyboardStr.nextLine();
            casa.getPortas()[portaIDCor-1].pintandoPorta(casa.getPortas()[portaIDCor-1], cor);
        }
        ...
        while (value > 0) {
            ...
            casa.getPortas()[portaIDEstado-1].alterarEstadoPorta(keyboardint, casa.getPortas()[portaIDEstado-1]);
            System.out.println("Caso deseja alterar o estado da porta: [ABERTO X FECHADO]\nDigite qualquer número > 0");
